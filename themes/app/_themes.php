...
<body>
    ...
    <div id="seNLogado" class="hidden">
        faça o login para concluir essa ação!
    </div>

    <div class="container">
        <div class="abas">
            <button  data-aba="homepage" data-open ><a href="<?= url ("/"); ?>">Homepage</a></button>
            <button data-aba="sobre"><a href="<?= url ("/sobre"); ?>">Sobre</a></button>
            <!-- <button data-aba="perguntas">Perguntas</button> -->
